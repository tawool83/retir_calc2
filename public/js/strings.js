const STRINGS = {
    ...
    "CONFIG": {
        ...
        "RETIRE_PORTFOLIO_LABEL": "포트폴리오",
        "RETIRE_PORTFOLIO_AUTO": "시나리오 자동",
        "TARGET_MONTHLY_CASHFLOW_LABEL": "목표 생활비",
        "SHARE_BUTTON": "시나리오",
    ...
    "OBSERVATION": {
        "TITLE": "파이어족 여정 요약",
        "RETIRE_RESULT": "파이어족 시점({0}세, {1}년)에 예상되는 총자산은 약 {2}입니다. ",
    ...
    "TABLE": {
        ...
        "HEADER_ANNUAL_CONTRIBUTION": "연간 투자액",
        "HEADER_RETURN": "주가성장평가액",
        "HEADER_DIVIDEND": "배당액",
        "HEADER_CAPITAL_GAIN_TAX": "양도세액",
        "HEADER_WITHDRAWAL": "연간인출액",
        "HEADER_BALANCE": "연말평가액",
    ...
    "EVENT_DIALOG": {
        ...
        "INFO_WITHDRAWAL": "이 나이부터 매월 생활비 등으로 인출할 금액입니다. 배당금, 수익, 원금 순으로 차감됩니다.<br/>1년간(1월~12월) 발생한 매매 차익과 손실을 합산하여 250만 원 초과분에 대해 22%의 세금이 부과됩니다.<br/>이전 값은 이 값으로 대체됩니다.",
        "INFO_INCOME": "국민연금, 개인연금 등 투자와 무관한 월별 고정 수입입니다. 월 인출액을 상쇄하는 효과가 있습니다.<br/>이 금액은 누적됩니다."
    },
    "PRESET_DIALOG": {
        "TITLE": "포트폴리오 프리셋 관리",
    ...
    "ONBOARDING": {
        "TITLE_STEP_1": "환영합니다!",
        "CONTENT_STEP_1": "파이어족이 되기 위한 긴 여정에 오신 것을 환영합니다. 몇 가지 간단한 단계를 통해 이 도구를 최대한 활용하는 방법을 안내해 드리겠습니다.",
    ...
    "FOOTER": {
        "COPYRIGHT": "© 2026 본 시뮬레이션의 결과는 사용자가 입력한 가정에 기반한 예측이며, 실제 미래 수익률을 보장하지 않습니다. 모든 투자의 최종 결정과 책임은 투자자 본인에게 있습니다. 이 정보는 투자 자문으로 간주되어서는 안 됩니다."
    }
};