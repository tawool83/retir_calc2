...
const STRINGS = {
    ...
    SCENARIO: {
        ...
        PRESET_BUTTON: "프리셋",
        ADD_BUTTON: "시나리오 추가",
        SUPPORTED_ITEMS: "지원 항목: <span class='font-semibold'>포트폴리오 변경</span>, <span class='font-semibold'>월 정기 투자금 변경</span>, <span class='font-semibold'>일시불</span>, <span class='font-semibold'>월 정기 출금</span>.",
    ...
    TABLE: {
        ...
        TOOLTIP_WITHDRAWAL: "연간 인출한 총 금액입니다. (일시불 출금 + 정기 출금)",
        TOOLTIP_BALANCE: "해당 연도 말 기준 총 잔액입니다.<br>계산식: <b>기초 잔액 + 연간 투자금 + 평가 수익 + 배당금 - 연간 총 출금</b>",
